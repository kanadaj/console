export default {
  ...
  required: ['dependencies', 'extensions', 'name', 'version'],
  ...
  definitions: {
    ...
    ContextProvider: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['provider', 'useValueHook'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    PVCStatus: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['priority', 'status', 'predicate'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    PVCDelete: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['predicate', 'onPVCKill', 'alert'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    AddAction: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['id', 'label', 'description', 'href'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    K8sVerb: {
      type: 'string',
      enum: ['create', 'get', 'list', 'update', 'patch', 'delete', 'deletecollection', 'watch'],
    },
    AddActionGroup: {
      type: 'object',
      additionalProperties: false,
    ...
    ClusterGlobalConfig: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['id', 'name', 'model', 'namespace'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    FileUpload: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['fileExtensions', 'handler'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    CatalogItemProvider: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['catalogId', 'type', 'provider'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    CatalogItemFilter: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['catalogId', 'type', 'filter'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    DetailsTabSection: {
      ...
      properties: {
        type: {
          type: 'string',
          const: 'topology.details/tab-section',
        },
        properties: {
          type: 'object',
          properties: {
            ...
            section: {
              $ref: '#/definitions/EncodedCodeRef',
              description:
                'Returns a section for the graph element or undefined if not provided. SDK component: <Section title={<optional>}>... padded area </Section>',
            },
            insertBefore: {
              anyOf: [
                {
    ...
    DetailsResourceLink: {
      ...
      properties: {
        type: {
          type: 'string',
          const: 'topology.details/resource-link',
        },
        properties: {
          type: 'object',
          properties: {
    ...
    DetailsResourceAlert: {
      ...
      properties: {
        type: {
          type: 'string',
          const: 'topology.details/resource-alert',
        },
        properties: {
          type: 'object',
          properties: {
    ...
    DashboardsCard: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['tab', 'position', 'component'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    DashboardsOverviewHealthPrometheusSubsystem: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['title', 'queries', 'healthHandler'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    DashboardsOverviewHealthURLSubsystem: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['title', 'url', 'healthHandler'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    DashboardsOverviewHealthResourceSubsystem: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['title', 'resources', 'healthHandler'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    DashboardsOverviewResourceActivity: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['k8sResource', 'component'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    K8sResourceKindReference: {
      ...
      description:
        'The canonical, unique identifier for a Kubernetes resource type. Maintains backwards-compatibility with references using the `kind` string field.',
    },
    GroupVersionKind: {
      type: 'string',
      description:
        'GroupVersionKind unambiguously identifies a kind. https://godoc.org/k8s.io/apimachinery/pkg/runtime/schema#GroupVersionKind TODO: Change this to a regex-type if it ever becomes a thing (https://github.com/Microsoft/TypeScript/issues/6579)',
    },
    Selector: {
      type: 'object',
      properties: {
    ...
    MatchExpression: {
      ...
      properties: {
        ...
        operator: {
          type: 'string',
          enum: ['Exists', 'DoesNotExist', 'In', 'NotIn', 'Equals', 'NotEqual'],
        },
        values: {
          type: 'array',
          items: {
    ...
    TopologyDisplayFilters: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['getTopologyFilters', 'applyDisplayOptions'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
    ...
    TopologyDecoratorProvider: {
      ...
      properties: {
        ...
        properties: {
          ...
          required: ['id', 'priority', 'quadrant', 'decorator'],
          additionalProperties: false,
        },
        flags: {
          $ref: '#/definitions/ExtensionFlags',
